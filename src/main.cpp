...
uint256 hashGenesisBlock("0x3bafea350a70f75e7a1cd279999faed71a51852aae88fed3c38553cecc810a92");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // LinX: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LinX Signed Message:\n";
...
int CMerkleTx::GetBlocksToMaturity() const
{
    if (!IsCoinBase())
        return 0;
    return max(0, (fTestNet ? COINBASE_MATURITY_TESTNET : COINBASE_MATURITY+20) - GetDepthInMainChain());
}
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        if (nVersion >= 1)
        {
            if ((!fTestNet && nHeight >= 1) || (fTestNet && nHeight >= 1)){
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0aea5b57d70bc19a9aa31310c9d4353640dee8c7cbf1db4d5155cd669eab6054");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "29th May, 2017 - BBC News - Former Blue Peter presenter John Noakes dies at 83";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("042345710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1496098800;
        ...
        if (fTestNet)
        {
            block.nTime    = 1496099297;
            block.nNonce   = 2015333;
        }
